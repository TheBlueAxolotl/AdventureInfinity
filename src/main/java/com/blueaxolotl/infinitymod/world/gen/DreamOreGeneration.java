...
public class DreamOreGeneration {
    public static void generateDreamOres(final BiomeLoadingEvent event) {
        for (DreamOreType ore : DreamOreType.values()) {
            OreFeatureConfig oreFeatureConfig = new OreFeatureConfig(
                    ModFillerBlocks.ModFillerBlockTypes.SLEEPY_STONE,
    ...
    private static ConfiguredFeature<?, ?> registerOreFeature(DreamOreType ore, OreFeatureConfig oreFeatureConfig,
