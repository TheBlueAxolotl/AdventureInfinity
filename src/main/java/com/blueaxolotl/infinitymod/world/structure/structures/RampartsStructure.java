package com.blueaxolotl.infinitymod.world.structure.structures;
...
public class RampartsStructure extends Structure<NoFeatureConfig> {
    public RampartsStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return RampartsStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(InfinityMod.MOD_ID, "ramparts/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Ramparts at " +
