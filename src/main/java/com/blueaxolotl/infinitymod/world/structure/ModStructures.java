package com.blueaxolotl.infinitymod.world.structure;

import com.blueaxolotl.infinitymod.InfinityMod;
import com.blueaxolotl.infinitymod.world.structure.structures.RampartsStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, InfinityMod.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> RAMPARTS =
            STRUCTURES.register("ramparts", RampartsStructure::new);

    public static void setupStructures() {
        setupMapSpacingAndLand(RAMPARTS.get(),
