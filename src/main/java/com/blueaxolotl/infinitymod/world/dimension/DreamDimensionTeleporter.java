package com.blueaxolotl.infinitymod.world.dimension;

import com.blueaxolotl.infinitymod.block.ModBlocks;
import com.blueaxolotl.infinitymod.block.PortalBlock;
...
public class DreamDimensionTeleporter implements ITeleporter {
    ...
    public DreamDimensionTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerWorld currentWorld, ServerWorld destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlockState(destinationPos, ModBlocks.DREAM_TELEPORTER.get().getDefaultState());
            }
        }
